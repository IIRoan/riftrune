...
type NavId = 'search' | 'collection' | 'decks' | 'settings';
      ...
      <View className="h-full w-12 items-center gap-1 overflow-hidden rounded-xl border border-border bg-card py-3 shadow-lg shadow-black/50">
        ...
        <View className="gap-1">
          <Pressable
            ...
            onPress={() => {
              // Placeholder — alerts surface not implemented yet
            }}
          >
            <Ionicons name="notifications-outline" size={18} className="text-muted-foreground" />
          </Pressable>
          <Pressable
